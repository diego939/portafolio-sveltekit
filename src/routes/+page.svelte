...
<div class="space-y-8 sm:space-y-16">
	...
	<section class="bg-white rounded-xl shadow-lg p-4 sm:p-6 md:p-8 text-center mx-4 sm:mx-6">
		...
		<div class="flex flex-wrap justify-center gap-2 mb-6 sm:mb-8 px-2">
			...
			<a href="https://wa.me/+543795315483?text=Hola Diego, vi tu portafolio y me gustaría conversar sobre una posible vacante..." target="_blank" rel="noopener noreferrer" class="group flex items-center px-2 sm:px-3 py-1 bg-purple-900 border border-purple-900 text-white rounded-full shadow-md text-xs font-semibold hover:bg-white hover:text-purple-900 transition-colors">
